    ...
    <div class="site-section" id="home-section">
        <div class="container">
          <div class="row">
            <div class="col-md-6 mb-5">
              <h1 class="text-white serif text-uppercase mb-4">Happy Reading</h1>
      ...
      <div class="site-section bg-light" id="features-section">
        <div class="container">
          <div class="row mb-5">
            <div class="col-md-7">
              <h2 class="heading">Kategori Novel</h2>
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="service h-100">
                <a href="{{ url('/kekasih')}}"><img src="{{asset('assetss/images/kek.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="service h-100">
                <a href="{{ url('/ikhlas')}}"><img src="{{asset('assetss/images/cc.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
                <div class="reviews-star float-left">
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="service h-100">
                  <a href="{{ url('/empat')}}"><img src="{{asset('assetss/images/mus.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
                <div class="reviews-star float-left">
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="service h-100">
                <a href="{{ url('/dilan')}}"><img src="{{asset('assetss/images/ln.jpeg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
                <div class="reviews-star float-left">
                </div>
              </div>
            </div>
      ...
      <div class="site-section bg-light">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="service h-100">
                <a href="{{ url('/suramadu')}}"><img src="{{asset('assetss/images/sm.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
              <div class="reviews-star float-left">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service h-100">
              <a href="{{ url('/misteri')}}"><img src="{{asset('assetss/images/mm.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
              <div class="reviews-star float-left">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service h-100">
              <a href="{{ url('/aku')}}"><img src="{{asset('assetss/images/mt.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
              <div class="reviews-star float-left">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service h-100">
              <a href="{{ url('/kamar')}}"><img src="{{asset('assetss/images/kmr.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
              <div class="reviews-star float-left">
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service h-100">
              <a href="{{ url('/koala')}}"><img src="{{asset('assetss/images/mal.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            <div class="reviews-star float-left">
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="service h-100">
              <a href="{{ url('/bronto')}}"><img src="{{asset('assetss/images/br.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
              <div class="reviews-star float-left">
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service h-100">
            <a href="{{ url('/babi')}}"><img src="{{asset('assetss/images/ba.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            <div class="reviews-star float-left">
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service h-100">
            <a href="{{ url('/marmut')}}"><img src="{{asset('assetss/images/mr.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            <div class="reviews-star float-left">
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service h-100">
            <a href="{{ url('/ubur')}}"><img src="{{asset('assetss/images/ubu.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            <div class="reviews-star float-left">
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service h-100">
            <a href="{{ url('/radikus ')}}"><img src="{{asset('assetss/images/rad.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
            <div class="reviews-star float-left">
            </div>
          </div>
        </div>
