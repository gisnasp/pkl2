  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="row justify-content-center">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/hujan2.jpg')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
                <div class="col-md-30"></div>
           <h6> Novel Hujan ini bercerita tentang seorang anak perempuan bernama Lail yang kehilangan kedua orangtuanya saat bencana alam, gunung meletus. Usia Lail saat itu masih sangat kecil, tigabelas tahun.
               Kejadian ini mengubah seluruh kehidupan Lail. Tanpa ayah dan ibu disisinya, memaksa Lail kecil berjuang hidup di panti sosial.</h6>
           <h6>Esok adalah seorang anak laki-laki yang berhasil menolong Lail dari bencana alam itu. Anak lelaki itu kehilangan keempat orang kakak laki-lakinya. Sedangkan kaki ibunya harus diamputasi.
               Esok kecil menjaga Lail yang tiba-tiba menjadi sebatang kara. Dia melindungi dan selalu menghibur Lail, hingga Esok dijadikan anak angkat oleh walikota karena kejeniusannya. Esok terpaksa membiarkan Lail tinggal di panti sosial. Esok harus melanjutkan pendidikan di ibukota.
                Dia akan berkutat dengan penelitian termutakhir.</h6>
            <h6>Esok menurut Lail adalah "anak laki-laki yang memegang tas punggungnya di lubang tangga darurat kereta bawah tanah.
                Anak laki-laki yang menjemputnya sebelum hujan asam turun. Anak laki-laki yang menjadi teman baiknya selama di tenda pengungsian. Saat Lail kehilangan ayah dan ibu, takdir menggantinya dengan Esok."
            </h6>
        </div>
    </div>
