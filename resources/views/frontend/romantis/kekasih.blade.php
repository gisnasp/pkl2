...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="container">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/kek.jpg')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
                <div class="col-md-30"></div>
           <h5> Awalnya aku hanya menyukai satu unggahan foto di akun Instagram-mu.
           </h5>
           <h5>Dan kini aku menyukai semua tentangmu.
                Aku suka, betapa kau tak pernah mengumbar janji cinta layaknya banyak lelaki.
           </h5>
           <h5>
                Aku suka, betapa kau lebih banyak membuktikan bahwa raguku tentangmu tak beralasan.
           </h5>
           <h5>
                Aku suka, bahwa kau adalah jodoh yang dijanjikan Tuhan untukku.
                Aku suka, dan bersyukur, karena kau adalah Natha-ku.
           </h5>
        </div>
    </div>
