...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="container">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/cc.jpg')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
                <div class="col-md-30"></div>
           <h5> Aku sudah berusaha mengikhlaskanmu. Namun, pada akhirnya, memang hanya kamu sosok yang kuyakini akan menjadi jodohku nanti.
           </h5>
           <h5>Ya, aku masih berharap kamulah yang menjadi pasanganku, meski sudah bertahun-tahun lamanya kita tak bertemu.
               Keyakinanku kepadamu tak pernah pudar, fatwa hatiku masih tetap sama.
           </h5>
           <h5>
                Aku ingin memperjuangkanmu, Ara, supaya kita dapat bersatu.
                Oleh karena itulah, wajar jika aku berharap kepada Allah agar kita bisa dipertemukan di saat yang tepat.
           </h5>
           <h5>
                Tapi, apakah kamu menyimpan keyakinan dan keinginan yang sama denganku?
           </h5>
           <h5>
