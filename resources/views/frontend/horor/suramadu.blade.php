...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="container">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/sm.jpg')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
                <div class="col-md-30"></div>
           <h5> " Jangan lompat.... TIDAK... jangan lompat!!!"
           </h5>
           <h5>
                Teriakan Adelia tertelan suara bising di Jembatan Suramadu.
                Orang disekitarnya tidak peduli karena memang tidak ada kejadian aneh yang mereka lihat. Namun, Adelia bisa dan tiak satu orang pun percaya....
           </h5>
           <h5>Setelah kejadian itu, dia bertekad untuk menyelidiki misteri Suramadu.
               Hingga suatu malam, ia menghilang dari rumah dan membuat panik Rosela, kakaknya. Rosela akhirnya tagu kalau Adelia pergi ke jembatan baru itu untuk menyelidiki misteri yang muncul setiap kabut datang.
           </h5>
           <h5>
                Menurut kumpulan artikel Adelia, kabut Suramadu sudah menelan beberapa korban yang tidak ditemukan Pihak berwajib pun sudah dikerahkan untuk mencari korban disekeliling jembatan.
                Namun, kabut misteri terlalu tebal untuk diungkap.
           </h5>
           <h5>
               penasaran yang turut menghalangi. Dibantu dua temannya, Viona dan Pepita, berhasilkah usaha Rosela menemukan Adelia? Atau,
               dia memang harus kehilangan sang adik untuk selamanya di telan kabut Suramadu.
           </h5>
        </div>
    </div>
