...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="container">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/mm.jpg')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
           ...
           <h5>
               Apakah makhluk itu yang berbicara padanya?
                Di bawah cahaya bulan yang menerobos masuk ke jendela ruangan, Rani melihat sosok itu mendekat ke arahnya. Makin lama makin dekat, sedangkan Rani tak mampu bergerak.
                Lidahnya terasa kelu sampai ia tak mampu berteriak minta tolong.
           </h5>
           <h5>
           ...
           <h5>
               Kalau pertanyaan itu ditujukan kepada Adi, jawabannya jelas AMBIL! Prioritasnya saat ini memang adalah membeli rumah demi meluluskan satu-satunya permintaan sang istri: berpisah dari mertua dan hidup mandiri.
               Ia tak ambil pusing dengan pikiran pasti-ada-apa-apa seperti Rani, istrinya.
           </h5>
           <h5>
               Adi boleh tidak percaya dengan keberadaan makhluk tak kasat mata.
               Akan tetapi, ia harus benar-benar meralat anggapannya saat melihat istrinya koma dan satu demi satu orang yang membantunya mengusut keanehan rumah barunya tewas secara misterius. Ini pasti ada apa-apa.
           </h5>
        </div>
    </div>
