...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="container">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/kmr.jpg')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
                <div class="col-md-30"></div>
           <h5>
            Ini adalah kisah tentang kamar
            O22 di sebuah apartemen mewah
            di Jakarta. Banyak peristiwa di
            luar logika terjadi di sini dan
            membuat oranq-orang angkat kaki
            karena mengalami hal-hal yang
            menyeramkan.
           </h5>
           <h5>
            Sekilas kamar O22
            ini tampak biasa dan tidak
            berbeda dengan kamar—kamar
            lainnya. Namun ternyata jauh
            sebelumya, di kamar ini menyimpan
            sebuah rahasia besar.
           </h5>
           <h5>
            Konon di kamar O22 ini tinggal
            sepasang kekasih yang tiba—tiba
            menghilang tanpa jejak, dan
            sejak saat itu kejadian demi
            kejadian aneh dan menegangkan
            pun dimulai dan dialami oleh
            penghuni-penghuni di sekitarnya.
           </h5>
        </div>
    </div>
