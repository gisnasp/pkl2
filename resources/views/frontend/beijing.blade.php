...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="container">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/beijing.png')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
                <div class="col-md-30"></div>
           <h6>Sehari sebelum pernikahan dilangsungkan, Asmara (Revalina S. Temat) mendapatkan kenyataan pahit bahwa kekasihnya, Dewa (Ibnu Jamil) ternyata sempat berselingkuh dengan teman sekantornya Anita (Cynthia Ramlan). Walau Dewa memohon agar pernikahan tetap dilanjutkan, Asma terlanjur patah hati. Terlebih, hubungan sekali yang dilakukan ternyata membuahkan janin, Anita hamil. Dengan membawa kesedihan, Asma pun menerima tawaran pekerjaan di Beijing, peluang yang didapatkan 
               lewat bantuan Sekar (Laudya Cynthia Bella) dan Ridwan (Deddy Mahendra Desta), suaminya.</h6>
           <h6>Di Beijing dalam salah satu perjalanan, Asma bertemu Zhongwen (Morgan Oey), lelaki tampan yang memperkenalkannya akan legenda cinta Ashima, putri cantik dari Yunan.Kebaikan dan perhatian Zhongwen, membuat Asma perlahan membuka hati. Walaupun sempat gamang ketika Dewa menyusulnya ke Beijing. Sayang, sebelum hubungan berlanjut, Asma terkena APS, 
               sebuah sindrom yang membuat nyawanya terancam dan bisa menemui kematian setiap waktu.Sebuah drama penutup akhir tahun, yang mengajarkan kepada kita: Jika tak kau temukan cinta, biarkan cinta menemukanmu.</h6>
        </div>
    </div>
