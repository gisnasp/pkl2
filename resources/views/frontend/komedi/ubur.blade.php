...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="container">
            <div class="col-md-30">
              <img src="{{asset('assetss/images/ubu.jpg')}}" alt="Image placeholder" class="img-fluid">
            </div>
          </div>
        <div class="container">
                <div class="col-md-30"></div>
           <h5>
             Hal kedua yang gue nggak sempat kasih tahu Iman: jadi orang yang dikenal publik harus tahan dengan asumsi-asumsi orang. Misalnya,
             orang-orang penuh dengan asumsi yang salah. Gue kurusan dikit, dikomentarin orang yang baru ketemu,
           </h5>
           <h5>
           <center>‘Bang Radit, kurusan, deh. Buat film baru, ya?’
            Gue geleng, ‘Enggak.’ Gue bilang, ‘Emang lagi diet aja.’ Dia malah balas bilang, ‘Ah, bohong! Paling abis putus cinta, kan?’</center>
           </h5>
           <h5>
              Giliran gue potong rambut botak, ada orang yang ketemu gue di mall nanya, ‘Wah botak sekarang? Lagi shooting Tuyul dan Mbak Yul Reborn, ya, Bang?’
              Kalau udah gitu gue cuma terkekeh sambil jawab, ‘Enggak, lagi cosplay jadi kacang Sukro, nih.’
           </h5>
           <h5>
               <center>*******</center>
           </h5>
           <h5>Ubur-ubur Lembur adalah buku komedi Raditya Dika.
               Bercerita tentang pengalamannya belajar hidup dari apa yang dia cintai, sambil menemukan hal remeh untuk ditertawakan di sepanjang perjalanan.
           </h5>
        </div>
    </div>
