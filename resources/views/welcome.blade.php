  ...
  <div class="site-wrap">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="service h-100">
                <a href="{{ url('/ayat2')}}"><img src="{{asset('assetss/images/ay.jpg')}}" alt="Image placeholder" class="img-fluid rounded"> </a>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7">
            <h2 class="heading">Novel Populer</h2>
            <p>Seiring berjalannya waktu setiap orang yang memiliki bakat membuat Novel selalu berkreasi untuk menghadirkan Novel terbaru
                yang dapat menarik banyak peminat.
            </p>
            <p class="mb-3">
        ...
        <div class="owl-carousel slide-one-item">
          <img src="{{asset('assets/booke/booke/images/stu.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/bi.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/mas.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/mu.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/cho.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/rin.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/kum.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/per.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/buk.png')}}" alt="Image" class="img-fluid">
          <img src="{{asset('assets/booke/booke/images/se.png')}}" alt="Image" class="img-fluid">
        </div>
      </div>
    </div>

    <div class="author  d-lg-flex" id="about-section">
      <div class="bg-img" style="background-image: url('assets/booke/booke/gambar/aa.jpg');"></div>
      <div class="text">
        <h3>Tentang Buku </h3>
